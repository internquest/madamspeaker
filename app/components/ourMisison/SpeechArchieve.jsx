...
// latest)
  ...
  return (
    ...
    //     <section style={{position: containertfix>.9&&leftmarue<1?'fixed':'',left: containertfix>.9&&leftmarue<1?'0':'',top: containertfix>.9&&leftmarue<1?'-900px':'',transform:leftmarue===1&&`translate(0px,702px)`}} className='w-full'>
        <section  ref={ref} className='h-[250vh] bg-[var(--black)] w-full relative text-white'>
            ...
            <div className='flex items-center justify-center sticky top-0 h-screen '>
                <div className='pt-[30px] px-[30px] pb-[20px] bg-white hover:bg-[#c2a0f8] hover:scale-125 text-[var(--black)] rounded-[var(--border-radius-medium)] group text-center uppercase z-[1] duration-500'>
                <h3 className='max-w-[600px] duration-500 group-hover:scale-50 scale-100 text-[62px]'>Enter the speech archieve</h3>
                </div>
