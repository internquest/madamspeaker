...
<section className='relative top-0 left-0  w-full '>
    <div className='h-screen bg-[var(--chanterelle)] flex justify-center items-end'>
        ...
        <figure className='left-[10%] top-[8%] absolute h-[160px] w-[260px] '>
        ...
        <figure className='left-[5%] top-[60%] absolute h-[160px] w-[260px] '>
        ...
        <figure className='left-[45%] top-[70%] absolute h-[160px] w-[260px] '>
        ...
        <figure className='left-[75%] top-[10%] absolute h-[160px] w-[260px] '>
        ...
        <figure className='left-[80%] top-[70%] absolute h-[160px] w-[260px] '>
